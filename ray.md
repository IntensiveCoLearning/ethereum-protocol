...
![](./img/ray/longestchain.png){:height="50%" width="50%"}
...
![](./img/ray/longestchain2.png){:height="50%" width="50%"}
...
![](./img/ray/bft.png){:height="50%" width="50%"}
...
![](./img/ray/vote.png){:height="50%" width="50%"}

还有一种情况是验证者不参与投票，导致验证者的投票率不足，这种情况下，验证者也会因为不活跃而被罚没 ETH。

![](./img/ray/vote2.png){:height="50%" width="50%"}
